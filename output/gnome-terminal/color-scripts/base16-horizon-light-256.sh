...
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-horizon-light-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#FDF0ED', '#F7939B', '#94E1B0', '#FBE0D9', '#DA103F', '#1D8991', '#DC3318', '#403C3D', '#BDB3B1', '#F7939B', '#94E1B0', '#FBE0D9', '#DA103F', '#1D8991', '#DC3318', '#201C1D']"
