...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Atelier Savanna Light 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-atelier-savanna-light-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#ecf4ee', '#b16139', '#489963', '#a07e3b', '#478c90', '#55859b', '#1c9aa0', '#526057', '#78877d', '#b16139', '#489963', '#a07e3b', '#478c90', '#55859b', '#1c9aa0', '#171c19']"
