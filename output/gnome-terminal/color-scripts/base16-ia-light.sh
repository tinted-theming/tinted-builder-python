#!/usr/bin/env bash
# Base16 iA Light - Gnome Terminal color scheme install script
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset cursor-foreground-color "'#f6f6f6'"
...
gset string palette "#f6f6f6:#9c5a02:#38781c:#c48218:#48bac2:#a94598:#2d6bb1:#181818:#898989:#9c5a02:#38781c:#c48218:#48bac2:#a94598:#2d6bb1:#f8f8f8"
gset string palette "['#f6f6f6', '#9c5a02', '#38781c', '#c48218', '#48bac2', '#a94598', '#2d6bb1', '#181818', '#898989', '#c43e18', '#dedede', '#bde5f2', '#767676', '#e8e8e8', '#8b6c37', '#f8f8f8']"
...
gset string cursor-foreground-color "'#f6f6f6'"
