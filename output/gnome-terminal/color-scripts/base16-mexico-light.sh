...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Mexico Light"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-mexico-light"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#f8f8f8', '#ab4642', '#538947', '#f79a0e', '#7cafc2', '#96609e', '#4b8093', '#383838', '#b8b8b8', '#dc9656', '#e8e8e8', '#d8d8d8', '#585858', '#282828', '#a16946', '#181818']"
...
gset string palette "['#f8f8f8', '#ab4642', '#538947', '#f79a0e', '#7cafc2', '#96609e', '#4b8093', '#383838', '#b8b8b8', '#dc9656', '#e8e8e8', '#d8d8d8', '#585858', '#282828', '#a16946', '#181818']"
