...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#1b1918', '#f22c40', '#7b9726', '#c38418', '#407ee7', '#6666ea', '#3d97b8', '#a8a19f', '#766e6b', '#df5320', '#2c2421', '#68615e', '#9c9491', '#e6e2e0', '#c33ff3', '#f1efee']"
...
gset string palette "['#1b1918', '#f22c40', '#7b9726', '#c38418', '#407ee7', '#6666ea', '#3d97b8', '#a8a19f', '#766e6b', '#df5320', '#2c2421', '#68615e', '#9c9491', '#e6e2e0', '#c33ff3', '#f1efee']"
