...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset cursor-background-color "'#8ca68c'"
        dset cursor-foreground-color "'#131513'"
...
gset string palette "#131513:#e6193c:#29a329:#98981b:#3d62f5:#ad2bee:#1999b3:#8ca68c:#687d68:#e6193c:#29a329:#98981b:#3d62f5:#ad2bee:#1999b3:#f4fbf4"
gset string palette "['#131513', '#e6193c', '#29a329', '#98981b', '#3d62f5', '#ad2bee', '#1999b3', '#8ca68c', '#687d68', '#87711d', '#242924', '#5e6e5e', '#809980', '#cfe8cf', '#e619c3', '#f4fbf4']"
gset string background_color "#131513"
gset string foreground_color "#8ca68c"
gset string bold_color "#8ca68c"
gset bool   bold_color_same_as_fg "true"
gset bool   cursor-colors-set "true"
gset string cursor-background-color "'#8ca68c'"
gset string cursor-foreground-color "'#131513'"
