...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2d2d2d', '#f2777a', '#99cc99', '#ffcc66', '#6699cc', '#cc99cc', '#66cccc', '#d3d0c8', '#747369', '#f99157', '#393939', '#515151', '#a09f93', '#e8e6df', '#d27b53', '#f2f0ec']"
...
gset string palette "['#2d2d2d', '#f2777a', '#99cc99', '#ffcc66', '#6699cc', '#cc99cc', '#66cccc', '#d3d0c8', '#747369', '#f99157', '#393939', '#515151', '#a09f93', '#e8e6df', '#d27b53', '#f2f0ec']"
