...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Edge Dark 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-edge-dark-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#262729', '#e77171', '#a1bf78', '#dbb774', '#73b3e7', '#d390e7', '#5ebaa5', '#b7bec9', '#3e4249', '#e77171', '#a1bf78', '#dbb774', '#73b3e7', '#d390e7', '#5ebaa5', '#3e4249']"
