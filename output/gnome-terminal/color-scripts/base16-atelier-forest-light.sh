#!/usr/bin/env bash
# Base16 Atelier Forest Light - Gnome Terminal color scheme install script
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#f1efee', '#f22c40', '#7b9726', '#c38418', '#407ee7', '#6666ea', '#3d97b8', '#68615e', '#9c9491', '#df5320', '#e6e2e0', '#a8a19f', '#766e6b', '#2c2421', '#c33ff3', '#1b1918']"
...
gset string palette "['#f1efee', '#f22c40', '#7b9726', '#c38418', '#407ee7', '#6666ea', '#3d97b8', '#68615e', '#9c9491', '#df5320', '#e6e2e0', '#a8a19f', '#766e6b', '#2c2421', '#c33ff3', '#1b1918']"
