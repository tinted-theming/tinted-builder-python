...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 iA Dark 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-ia-dark-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#1a1a1a', '#d88568', '#83a471', '#b99353', '#8eccdd', '#b98eb2', '#7c9cae', '#cccccc', '#767676', '#d88568', '#83a471', '#b99353', '#8eccdd', '#b98eb2', '#7c9cae', '#f8f8f8']"
