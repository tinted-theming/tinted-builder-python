...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Atelier Dune Light 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-atelier-dune-light-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#fefbec', '#d73737', '#60ac39', '#ae9513', '#6684e1', '#b854d4', '#1fad83', '#6e6b5e', '#999580', '#d73737', '#60ac39', '#ae9513', '#6684e1', '#b854d4', '#1fad83', '#20201d']"
