...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#FFFFFF', '#FF0086', '#00C918', '#ABA800', '#3777E6', '#AD00A1', '#1FAAAA', '#101010', '#B0B0B0', '#FD8900', '#E0E0E0', '#D0D0D0', '#000000', '#151515', '#CC6633', '#202020']"
...
gset string palette "['#FFFFFF', '#FF0086', '#00C918', '#ABA800', '#3777E6', '#AD00A1', '#1FAAAA', '#101010', '#B0B0B0', '#FD8900', '#E0E0E0', '#D0D0D0', '#000000', '#151515', '#CC6633', '#202020']"
