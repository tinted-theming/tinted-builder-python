...
gset string palette "#2d2d2d:#d25252:#a5c261:#ffc66d:#6c99bb:#d197d9:#bed6ff:#cccccc:#777777:#d25252:#a5c261:#ffc66d:#6c99bb:#d197d9:#bed6ff:#ffffff"
gset string palette "['#2d2d2d', '#d25252', '#a5c261', '#ffc66d', '#6c99bb', '#d197d9', '#bed6ff', '#cccccc', '#777777', '#f9a959', '#393939', '#515151', '#b4b7b4', '#e0e0e0', '#f97394', '#ffffff']"
