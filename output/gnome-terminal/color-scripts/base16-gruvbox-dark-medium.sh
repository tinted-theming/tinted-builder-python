...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Gruvbox dark, medium"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-gruvbox-dark-medium"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#282828', '#fb4934', '#b8bb26', '#fabd2f', '#83a598', '#d3869b', '#8ec07c', '#d5c4a1', '#665c54', '#fe8019', '#3c3836', '#504945', '#bdae93', '#ebdbb2', '#d65d0e', '#fbf1c7']"
...
gset string palette "['#282828', '#fb4934', '#b8bb26', '#fabd2f', '#83a598', '#d3869b', '#8ec07c', '#d5c4a1', '#665c54', '#fe8019', '#3c3836', '#504945', '#bdae93', '#ebdbb2', '#d65d0e', '#fbf1c7']"
