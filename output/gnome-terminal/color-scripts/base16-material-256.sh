...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Material 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-material-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#263238', '#F07178', '#C3E88D', '#FFCB6B', '#82AAFF', '#C792EA', '#89DDFF', '#EEFFFF', '#546E7A', '#F07178', '#C3E88D', '#FFCB6B', '#82AAFF', '#C792EA', '#89DDFF', '#FFFFFF']"
