...
gset string palette "['#2b303b', '#bf616a', '#a3be8c', '#ebcb8b', '#8fa1b3', '#b48ead', '#96b5b4', '#c0c5ce', '#65737e', '#d08770', '#343d46', '#4f5b66', '#a7adba', '#dfe1e8', '#ab7967', '#eff1f5']"
...
gset string cursor-foreground-color "'#2b303b'"
